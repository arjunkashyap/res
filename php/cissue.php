	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		if($flag)
		{
			echo "<div class=\"archive_holder\">
				<div class=\"archive_title\">Current Issue<br />Volume&nbsp;".intval($volume)." - Issue&nbsp;".intval($issue)."&nbsp;&nbsp;:&nbsp;&nbsp;".$month_name{intval($month)}."&nbsp;".$year."</div>
		...
		echo "<li>\n";
		echo "<span class=\"titlespan\"><a target=\"_blank\" href=\"show_article.php?volume=$volume&issue=$issue&titleid=$titleid&page=$page\">$title</a></span><span class=\"authorspan\"> (p.".intval($page).")</span>";
