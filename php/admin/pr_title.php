...
for($i=0;$i<$num_rows;$i++)
{
	...
	$features = $features . "<option>" . $row['feat_name'] . "</option>\n";
}
...
echo "<form method=\"POST\" action=\"update_title.php\">
		<input name=\"titleid_up\" type=\"hidden\" value=\"$titleid\" />
		<input name=\"authid_up\" type=\"hidden\" value=\"$authid\" />
		<input name=\"volume_up\" type=\"hidden\" value=\"$volume\" />
		<input name=\"issue_up\" type=\"hidden\" value=\"$issue\" />
<table>
<tr>
	<td class=\"fcol\">Title:&nbsp;&nbsp;</td>
	<td class=\"scol\">
		<input class=\"txtbox\" id=\"tid\" name=\"title_up\" type=\"text\" value=\"$title\" size=\"55\"/>
		&nbsp;
		<span class=\"titlespan\"><a href=\"../../Volumes/$volume/$issue/index.djvu?djvuopts&page=$viewpage.djvu&zoom=page\" target=\"_blank\">View Article</a></span><span class=\"authorspan\"></span>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td class=\"scol\">
		<textarea class=\"txtbox\" id=\"absid\" name=\"abstract\" type=\"text\"  rows=\"10\" cols=\"40\">$abstract
		</textarea><br />
	</td>
</tr>
<tr>
			...
			foreach ($aut as $aid)
			{
					...
					if($num_rows2)
					{
						...
						echo "<tr>
								...
								<td>
									<input class=\"txtbox\" type=\"text\" name=\"auth[]\" value=\"$authorname\"/ readonly=\"readonly\">&nbsp;&nbsp;
									<div class=\"editlink\"><a href=\"pr_author?authid=$aid\">Edit</a></div>
								</td>
							</tr>";
