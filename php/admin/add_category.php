...
for($i=1;$i<=$num_rows1;$i++)
{
	...
	$features = $features . "<option>" . $row1['feat_name'] . "</option>\n";
}

echo "<form method=\"POST\" action=\"update_category.php\">
<table>
<tr>
	<td class=\"fcol\">Existing Category:&nbsp;&nbsp;</td>
	<td class=\"scol\"><select class=\"txtbox\" name=\"features\" id=\"fid\" readonly=\"readonly\">";
	echo $features;
	echo"</select><br />
</td>
</tr>
...
<tr>
	<td class=\"fcol\">New Category:&nbsp;&nbsp;</td>
	<td class=\"scol\">
		<input class=\"txtbox\" id=\"catid\" name=\"category\" type=\"text\" value=\"$category\" size=\"55\"/>
	</td>
</tr>
<tr>
	<td class=\"fcol\"></td>
