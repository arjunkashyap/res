...
<div class="page">
	...
	<div class="mainpage_volume">
		...
		<div class="archive_holder">
			<div class="archive_title">Merge Categories</div>
...
echo "<form method=\"POST\" action=\"merge_cat1.php\">";
...
for($i=1;$i<=$num_rows1;$i++)
{
	...
	if($feat_name != "")
	{
		echo "<input name=\"features[]\" type=\"checkbox\" value=\"$feat_name\" id=\"$featid\" />&nbsp;&nbsp;$feat_name <br />";
	}
}

echo"<input type=\"submit\" value=\"Merge Category\">
</form>";
