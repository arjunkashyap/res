...
echo "<form method=\"POST\" action=\"merge_cat_pr.php\">";

for($i=0;$i<sizeof($category); $i++)
{
	echo "<input name=\"features[]\" type=\"checkbox\" value=\"$category[$i]\" CHECKED/>&nbsp;&nbsp;$category[$i]<br />";
}

echo"<input type\"text\" name=\"newcategory\" value=\"\" size=\"40\" />
<input type=\"submit\" value=\"Merge Category\" />
</form>";
