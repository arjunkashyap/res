	...
	<div class="header">
		...
		<div class="nav">
			<ul>
				...
				<li><a class="active" href="cissue.php">Current Issue</a></li>
...
$query = "select * from article where volume='$cvolume' and issue='$cissue' order by page";
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		if($flag)
		{
			echo "<div class=\"archive_holder\">
				<div class=\"archive_title\">Current Issue - Volume&nbsp;".intval($cvolume).", Issue&nbsp;".intval($cissue).",&nbsp;".$month_name{intval($month)}."&nbsp;$dt&nbsp;".$year."</div>
				<div class=\"archive_sp\">
					<ul>";
			$flag=0;
		}
		...
		{
			echo "<li>\n";
			echo "<span class=\"featurespan_big\">".$feature."</span>\n";
			echo "<ul>\n";
		}
		
		echo "<li>\n";
		echo "<span class=\"titlespan\"><a href=\"../../Volumes/$cvolume/$cissue/index.djvu?djvuopts&page=$page.djvu&zoom=page\" target=\"_blank\">$title</a></span><span class=\"authorspan\"> (".intval($page).")</span>";
		echo "<span class=\"titlespan\">&nbsp;&nbsp;|&nbsp;&nbsp;</span><span class=\"yearspan\"><a href=\"toc.php?vol=$cvolume&issue=$cissue\">".$month_name{intval($month)}."&nbsp;".$year.",&nbsp;".intval($cvolume)."&nbsp;(".$cissue.")</a></span>";
		echo "<span class=\"downloadspan\">&nbsp;&nbsp;&nbsp;&nbsp;<a title=\"Download Article\" href=\"../../Downloads/download_djvu.php?titleid=$titleid\" target=\"_blank\">DjVu</a>&nbsp;|&nbsp;<a title=\"Download Article\" href=\"../../Volumes/$cvolume/$cissue/$page.pdf\" target=\"_blank\">PDF</a></span>";
