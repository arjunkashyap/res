...
<div class="page">
	...
	<div class="mainpage_volume">
		...
		<div class="archive_holder">
			<div class="archive_title">Deleting Existing Category</div>
...
$query1 = "select featid from feature where feat_name='$category'";
...
if($num_rows1)
{
	...
	$query2 = "select * from article where featid='$featid'";
	$result2 = mysql_query($query2);
	$num_rows2 = mysql_num_rows($result2);

	if($num_rows2)
	{
		$query3 = "update article set featid='10001' where featid='$featid'";
		$result3 = mysql_query($query3);
		if($result3)
		{
			echo "Affected " . mysql_affected_rows() . " rows in article table <br />";   
		}
	
		$query4 = "update searchtable set featid='10001' where featid='$featid'";
		$result4 = mysql_query($query4);
		if($result4)
		{
			echo "Affected " . mysql_affected_rows() . " rows in search table <br />";   
		}
	}
	else
	{
		echo "No articles exist in this category <br />";
	}

$query5 = "delete from feature where featid='$featid'";
$result5 = mysql_query($query5);
if($result5)
{
	echo "Successfully deleted $category from feature table <br />";
}
else
{
	echo "Error in deletion of $category " . mysql_error();
}	
