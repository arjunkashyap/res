...
<div class="page">
	...
	<div class="mainpage_volume">
		...
		<div class="archive_holder">
			<div class="archive_title">Deleting An Existing Article</div>
...
$query1 = "delete from article where titleid='$titleid'";
$result1 = mysql_query($query1);
if(!($result1))
{
	echo "Error in deleting article($titleid): " . mysql_error();
}
else
{
	$query2 = "delete from searchtable where titleid='$titleid'";
	$result2 = mysql_query($query2);
	if(!($result2))
	{
		echo "Error in deleting article($titleid) from searchtable :" . mysql_error();
	}
}
