...
<div class="page">
	...
	<div class="mainpage_volume">
		...
		<div class="archive_holder">
			<div class="archive_title">Choose Volume</div>
...
if($num_rows)
{
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		if($num_rows1)
		{
			...
			echo "<li><span class=\"yearspan\"><a href=\"issue.php?vol=$volume&amp;year=$year\" target=\"_blank\">$year (Volume $volume_int)</a></span></li>";
		}
	}
}
