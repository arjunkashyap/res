...
<div class="page">
	...
	<div class="mainpage_volume">
		...
		<div class="archive_holder">
			<div class="archive_title">Adding New Category</div>
...
$uc_category = ucwords(strtolower($category));

$query1 = "select * from feature where feat_name='$uc_category'";
$result1 = mysql_query($query1);
$num_rows1 = mysql_num_rows($result1);

if($num_rows1)
{
	echo "Already there is a category by name: $category <br />";
	echo "<a href=\"add_category.php\">Click here</a> to go back and correct it";
}
else
{

	$query2 = "insert into feature values('$uc_category','')";
	$result2 = mysql_query($query2);
	if($result2)
	{
		echo  "Successfully inserted $uc_category feature <br />";	
	}
	else
	{
		echo  "Error in insertion to feature table:" . mysql_errno();
	}
}
