...
{
	$fl = 1;
	$error_msg = $error_msg . "Authorname should not be empty <br />";
}
...
{
	echo $error_msg . "<br />";
	echo "Go back and enter authorname <br />";
}
else
{
	include("connect.php");
	...
	if($num_rows)
	{
		...
		if($authid == $oldauthid)
		{
			echo "update only author table <br />";
/*
